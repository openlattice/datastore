...
public class CsvHttpMessageConverter extends AbstractGenericHttpMessageConverter<Iterable<Multimap<FullQualifiedName, ?>>>{
	...
	@Override
	public Iterable<Multimap<FullQualifiedName, ?>> read(Type type, Class<?> contextClass, HttpInputMessage inputMessage)
			throws IOException, HttpMessageNotReadableException {
        throw new UnsupportedOperationException( "CSV is not a supported input format" );
	}

	@Override
	protected void writeInternal(Iterable<Multimap<FullQualifiedName, ?>> t, Type type, HttpOutputMessage outputMessage)
	...
	@Override
	protected Iterable<Multimap<FullQualifiedName, ?>> readInternal(Class<? extends Iterable<Multimap<FullQualifiedName, ?>>> clazz,

...
public class BabyAclTest extends BootstrapDatastoreWithCassandra {
    ...
    private void entitySetTest() {
        ...
        // Test 2: Citizen is given the DISCOVER permission for NATION_SECRET_SERVICE. RandomGuy also got added to the role Reader.
    ...
    private void propertyTypeInEntityTypeTest() {
        ...
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_READER, NATION_CITIZENS, new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_READER, NATION_CITIZENS, ADDRESS, ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_READER, NATION_CITIZENS,POSITION, ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_READER, NATION_CITIZENS, LIFE_EXPECTANCY, ImmutableSet.of(Permission.READ) );
        ...
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_WRITER, NATION_CITIZENS,  new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_WRITER, NATION_CITIZENS,  ADDRESS, ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_WRITER, NATION_CITIZENS,  POSITION, ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntityType( ROLE_WRITER, NATION_CITIZENS,  LIFE_EXPECTANCY, ImmutableSet.of(Permission.WRITE) );
        ...
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), Permission.READ ) );
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, ADDRESS, Permission.READ ) );
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, POSITION, Permission.READ ) );
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, LIFE_EXPECTANCY, Permission.READ ) );        
        ...
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), Permission.WRITE ) );
        Assert.assertTrue( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, ADDRESS, Permission.WRITE ) );
        Assert.assertFalse( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, POSITION, Permission.WRITE ) );
        Assert.assertFalse( ps.checkUserHasPermissionsOnPropertyTypeInEntityType( USER_RANDOMGUY.getRoles(), NATION_CITIZENS, LIFE_EXPECTANCY, Permission.WRITE ) );        
        ...
        // Test 4.67: Read data - should be able to read (EMPLOYEE_ID, ADDRESS, POSITION), but only EMPLOYEE_ID and ADDRESS are non-null.
    ...
    private void propertyTypeInEntitySetTest() {
        ...
        setUser(USER_RANDOMGUY);
        USER_RANDOMGUY.addRoles( ImmutableSet.of(ROLE_READER, ROLE_WRITER));
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_READER, NATION_CITIZENS, NATION_SECRET_SERVICE, new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_READER, NATION_CITIZENS, NATION_SECRET_SERVICE, ADDRESS, ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_READER, NATION_CITIZENS, NATION_SECRET_SERVICE, POSITION, ImmutableSet.of(Permission.READ) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_READER, NATION_CITIZENS, NATION_SECRET_SERVICE, LIFE_EXPECTANCY, ImmutableSet.of(Permission.READ) );
                
        // Test 1: give Writer WRITE rights for EMPLOYEE_ID, ADDRESS, POSITION, and LIFE_EXPECTANCY in NATION_SECRET_SERVICE.
        // Expected: Being able to read and write all data types.
        
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_WRITER, NATION_CITIZENS, NATION_SECRET_SERVICE,  new FullQualifiedName(NAMESPACE, EMPLOYEE_ID), ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_WRITER, NATION_CITIZENS, NATION_SECRET_SERVICE,  ADDRESS, ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_WRITER, NATION_CITIZENS, NATION_SECRET_SERVICE,  POSITION, ImmutableSet.of(Permission.WRITE) );
        ps.addPermissionsForPropertyTypeInEntitySet( ROLE_WRITER, NATION_CITIZENS, NATION_SECRET_SERVICE,  LIFE_EXPECTANCY, ImmutableSet.of(Permission.WRITE) );
        ...
        // Test 2.67: Read data - should be able to read all data, but only EMPLOYEE_ID and ADDRESS are non-null.
        System.out.println( " -- READ TEST 2 --" );
        Iterable<Multimap<FullQualifiedName, Object>> result2 = dataService.getAllEntitiesOfEntitySet( NATION_SECRET_SERVICE, NATION_CITIZENS.getNamespace(), NATION_CITIZENS.getName() );
        for( Multimap<FullQualifiedName, Object> entity : result2 ){
            System.out.println( entity );
        }
        ...
        // Test 3: give Writer WRITE rights for EMPLOYEE_ID, ADDRESS, POSITION, and LIFE_EXPECTANCY in NATION_SECRET_SERVICE
